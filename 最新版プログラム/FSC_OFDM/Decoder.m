...
%y=[20*64*2,1],g=[2,7],mem=64 ⇒ 得られたデータを転置している。
%*****************************************************************
% Decoder is convolution decoder using soft dicision Viterbi algorithm.(軟判定ビタビアルゴリズム)
...
if mem == len_total % The case of unlimited memory length
     ...
     Data = x_hat(1,1:len_x).';% [20*64*2-6,1]
