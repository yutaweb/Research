function Datatx=transmitter_non_FSS_MIMO_OFDMA(Gen_data,Numsymb,wordsize,NumCarr,guardtype,...
...
proc_gain_block=NumCarr/proc_gain;% 64/16=1
spread=hadamard(proc_gain);% [16,16]のアダマール行列
...
% [20,1 ～16,2] ⇒ ユーザ1に割り当てる
% [20,17～32,2] ⇒ ユーザ2に割り当てる
% [20,33～48,2] ⇒ ユーザ3に割り当てる
% [20,49～64,2] ⇒ ユーザ4に割り当てる
