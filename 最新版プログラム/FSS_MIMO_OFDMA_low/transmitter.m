...
Datatx2=zeros(Numsymb,NumCarr,NumCarr,Num_Tx);% [20,64,64,2]
...
%disp(Datatx1);
%[20,64,1,2]:アンテナ1からのデータは[20,64,1,1]でアンテナ2からのデータは[20,64,1,2]である。
...
for transmit=1:Num_Tx
    for fscb=1:proc_gain_block% 1～1
       for fsc=1:proc_gain% 1～64
          Datatx2(:,(fscb-1)*proc_gain+1:fscb*proc_gain,fsc,transmit)=...% [20,64,1～64,2]
...
Datatx(Num_pilot+1:Numsymb+Num_pilot,:,:)=permute(Datatx2,[1 2 4 3]);% [20,64,2,1]のデータ
